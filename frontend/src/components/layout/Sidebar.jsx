...
const menuItems = {
  SA: [
    ...
    { to: '/master/kategori-asset', icon: 'bi-tags', label: 'Master Kategori Asset' },
    { to: '/master/lokasi-asset', icon: 'bi-geo-alt', label: 'Master Lokasi Asset' },
    ...
    { to: '/vehicle', icon: 'bi-car-front', label: 'Vehicle' },
    ...atkItems,
  ...
  HGA: [
    ...
    { to: '/master/kategori-asset', icon: 'bi-tags', label: 'Kategori Asset' },
    { to: '/master/lokasi-asset', icon: 'bi-geo-alt', label: 'Lokasi Asset' },
    { to: '/asset', icon: 'bi-box', label: 'Asset' },
    { to: '/maintenance/ticket', icon: 'bi-wrench', label: 'Maintenance' },
    { to: '/procurement/pr', icon: 'bi-cart', label: 'Procurement' },
    { to: '/vehicle', icon: 'bi-car-front', label: 'Vehicle' },
